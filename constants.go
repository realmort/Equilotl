...
const ReleaseUrl = "https://api.github.com/repos/realmort/Equicord/releases/latest"
...
var UserAgent = "Equilotl/" + buildinfo.InstallerGitHash + " (https://github.com/realmort/Equilotl)"
